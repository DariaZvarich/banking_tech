...
describe('Banking', () => {
    ...
    it('should reject invalid dates in transactions', () => {
        expect(() => banking.deposit(1000, '2023-01-10')).toThrow('Invalid date format');
        expect(banking.calculateBalance()).toEqual(0);
    });
    ...
    it('should print the account statement in a table format', () => {
        ...
        expect(consoleLogSpy).toHaveBeenCalledWith(
            "date     || credit     || debit     || balance10/01/2023     || 1000     || undefined     || 100013/01/2023     || 2000     || undefined     || 300014/01/2023     || undefined     || 500     || 2500"
        );
