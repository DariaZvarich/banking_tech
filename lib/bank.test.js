const {Transaction, TransactionManager, StatementFormatter} = require('./bank');
...
describe('TransactionManager', () => {
    ...
    it('should reject negative deposits', () => {
        expect(() => transactionManager.deposit(-500, '12/01/2023')).toThrow('Invalid deposit amount');
...
//         transactionManager.deposit(1000, '10/01/2023');
//         expect(() => transactionManager.withdraw(1500, '14/01/2023')).toThrow('Insufficient balance');
//     });
...
//         expect(transactions[0]).toEqual({ date: '10/01/2023', credit: 1000, balance: 1000});
//         expect(transactions[1]).toEqual({ date: '13/01/2023', credit: 2000, balance: 3000});
//         expect(transactions[2]).toEqual({ date: '14/01/2023', debit: 500, balance: 2500})
//     });
